...
export default function CartPage() {
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="rounded-[28px] border border-[#d9d2c8] bg-[#f8f6f2] p-6 md:p-8">
        <p className="mb-6 text-lg font-medium">
          Итого: <span className="font-semibold">{formatMoney(totalMinor)}</span>
        </p>
        <Link
          href="/checkout"
        ...
        <p className="mt-4 text-xs text-zinc-600">Далее — форма контактов и оплата Stripe (если ключи заданы на сервере).</p>
      </div>
    </section>
  );
}
