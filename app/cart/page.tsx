            ...
            <div className="space-y-4">
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    <div className="grid grid-cols-[auto_6rem_minmax(0,1fr)] items-center gap-x-3 md:hidden">
                      <button
                        type="button"
                    ...
                    <div className="hidden md:grid md:grid-cols-[auto_auto_minmax(180px,1fr)_auto] md:items-center md:gap-5">
                      <button
                        type="button"
                        onClick={() => removeItem(item.id)}
                        className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[#d9d2c8] bg-white text-zinc-700 transition hover:bg-[#f4f0ea]"
